...
const TundraProfile = (props) => {
  return (
    <div>
      ...
      <div>
        <p>
          T47C, self-named Tundra, currently is AWOL from Seyfert Interplentary.<br/>
          Reports indicate he fancies himself a mercenary, utilizing his enhancements<br/>
          to pick up lucrative and dangerous constracts across multiple systems.<br/>
          Further reporting indicates he commandeered the frigate class ship, Bryyo;<br/>
          Analysis suggests he perpetrated this act of piracy alone.
        </p>
        <p>
          SPI has confirmed multiple Class 1A abilities in the subject:
          <ul>
            <li>Enhanced strength, speed, stamina, reflexes</li>
            <li>Cryokinetics, or manipulative hypothermic abilities</li>
            <li>Bladed weaponry--untrained by SPI, but skilled</li>
          </ul>
        </p>
        <p>
          SPI has confirmed other Class 1C abilities:
          <ul>
            <li>Firearms training</li>
            <li>Stealth training and limited spycraft</li>
          </ul>
        </p>
        <p>
          Under no circumstance should an SPI employee or contractor approach or engage<br/>
          the subject. If incidental contact occurs, immediately contact SPI Security<br/>
          Services. Should T47C approach you, retreat to a secure SPI location immediately<br/>
          and notify either SPI Security Services or Seyfert Advanced Biomedical of said<br/>
          contact.<br/><br/>

          T47C is armed and extremely dangerous.
        </p>
        {props.notice}
      </div>
    </div>
